...
export class OrderComponent implements OnInit {
  ...
  Additem(event){
    ...
    let maincourse = event['item'].category.includes('main') ? 'main' : event['item'].category.includes('deserts') ? 'desert' : event['item'].category.includes('breverage') ? 'breverage' : event['item'].category

    

    this.handleItemAdd(maincourse+ '-' +event['item'].subCategory,event['item'].index,event['item'])
  ...
  minusitem(event){
    ...
    this.handleItemMinus(maincourse + '-' +event['item'].subCategory,event['item'].index,event['item'])
